...
let botonRanking = document.querySelector(".irAlRanking")
...
function jugadoresRanking() {
  let jugador1 ={nombre: "Esteban Quito", puntuacion: 270};
  let jugador2 ={nombre: "Alan Brito", puntuacion: 200};
  let jugador3 ={nombre: "Aitor Menta", puntuacion: 150};
  let jugador4 ={nombre: "Elsa Pito", puntuacion: 210};
  let jugador5 ={nombre: "Ana Conda", puntuacion: 100};
  let jugador0 ={nombre: nombrePlayer, puntuacion: preguntasAcertadas.length * 20};


  ranking =  new Array(jugador0,jugador1,jugador2,jugador3,jugador4,jugador5);
